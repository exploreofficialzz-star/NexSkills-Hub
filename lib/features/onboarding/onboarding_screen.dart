    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('Pick your primary learning track',
              style:
        ...
        children: [
          ...
          const Text("What's your\ncurrent level?",
              style: TextStyle(
                  ...
                  letterSpacing: -1)),
          const SizedBox(height: 8),
          const Text('We will tailor your learning path',
              style:
                  TextStyle(color: AppColors.textSecondary, fontSize: 16)),
          const SizedBox(height: 32),
          _LevelTile(
        ...
        children: [
          ...
          const Text('Set your\ndaily goal',
              style: TextStyle(
                  ...
                  letterSpacing: -1)),
          const SizedBox(height: 8),
          const Text('Consistency beats intensity every time',
              style:
                  TextStyle(color: AppColors.textSecondary, fontSize: 16)),
          ...
          ...[
            ...
            (30, '🔥', 'Committed', '3 lessons — accelerate fast'),
                ...
                child: _GoalTile(
                  ...
                  onTap: () =>
                      setState(() => _dailyGoalMinutes = g.$1),
                ),
              )),
...
class _LevelTile extends StatelessWidget {
  final String level, emoji, title, subtitle;
  final bool selected;
  final VoidCallback onTap;
